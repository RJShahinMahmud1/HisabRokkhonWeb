                     ...
                     <div className="flex gap-2 pt-2 pb-2 select-none px-1">
                         <div className="relative group flex-1">
                             <div className={`absolute bottom-full left-0 mb-2 w-max ${activeReactionPostId === post.id ? 'flex' : 'hidden group-hover:flex'} bg-white dark:bg-slate-800 shadow-[0_4px_24px_rgba(0,0,0,0.15)] rounded-full px-2 py-1 gap-1.5 border border-slate-200 dark:border-slate-700 z-10 transition-all duration-200 scale-100 origin-bottom`}>
                                 <button onClick={(e) => { e.stopPropagation(); handleSetReaction(post.id, activeProfileId, 'like'); }} className="p-1.5 hover:scale-130 hover:-translate-y-1.5 transition-all text-2xl" id="profile_react_btn_like">👍</button>
                                 <button onClick={(e) => { e.stopPropagation(); handleSetReaction(post.id, activeProfileId, 'love'); }} className="p-1.5 hover:scale-130 hover:-translate-y-1.5 transition-all text-2xl" id="profile_react_btn_love">❤️</button>
                                 <button onClick={(e) => { e.stopPropagation(); handleSetReaction(post.id, activeProfileId, 'wow'); }} className="p-1.5 hover:scale-130 hover:-translate-y-1.5 transition-all text-2xl" id="profile_react_btn_wow">😲</button>
                                 <button onClick={(e) => { e.stopPropagation(); handleSetReaction(post.id, activeProfileId, 'haha'); }} className="p-1.5 hover:scale-130 hover:-translate-y-1.5 transition-all text-2xl" id="profile_react_btn_haha">😂</button>
                                 <button onClick={(e) => { e.stopPropagation(); handleSetReaction(post.id, activeProfileId, 'angry'); }} className="p-1.5 hover:scale-130 hover:-translate-y-1.5 transition-all text-2xl" id="profile_react_btn_angry">😡</button>
                             </div>
                             <button 
                                 ...
                                 onClick={(e) => {
                                     ...
                                     handleSetReaction(post.id, activeProfileId, 'like');
                                 }}
